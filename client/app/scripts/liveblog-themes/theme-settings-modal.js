(function() {
    ...
    //ThemeSettingsModal.$inject = ['$scope', 'api', '$q', 'lodash', 'notify'];
    //function ThemeSettingsModal($scope, api, $q, _, notify) {
    //    console.log('scope', $scope.vm.theme);
    //    console.log('this', this);
    //    var vm = this;
    //    let settings = {};

    //    if (vm.theme && vm.theme.settings)
        ...
        function(api, $q, lodash, notify) {
            return {
                ...
                link: function(scope) {
                    ...
                    scope.vm = vm;
                    console.log('modal open', vm.modalOpened, scope.vm.modalOpened);
                    // Initialization
                    /**
                     * Collect a list of options for the given theme and its parents
                     * @param {object} theme
