...
FLASKS3_BUCKET_NAME = AMAZON_CONTAINER_NAME
FLASKS3_USE_HTTPS = ( env('AMAZON_USE_SSL', 'False').lower() in ("yes", "true", "on", "1") )
FLASKS3_URL_STYLE = env('AMAZON_URL_STYLE', None)
FLASKS3_BUCKET_DOMAIN = env('AMAZON_BUCKET_DOMAIN', None)
FLASKS3_ENDPOINT_URL = env('AMAZON_ENDPOINT_URL', None)
FLASKS3_CDN_DOMAIN = env('AMAZON_CDN_DOMAIN', None)
