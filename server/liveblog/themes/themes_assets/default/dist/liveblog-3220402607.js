    ...
    _createClass(Permalink, [{
        ...
        value: function getUrl(id) {
            ...
            if (this.href.indexOf(DELIMITER) === -1) {
                ...
                var regexHash = new RegExp(this.escapeRegExp(this.PARAM_NAME) + '=[^&#]*');
