...
from .blogslist import (
    BlogsListService,
    BlogsListResource,
    bloglist_assets_blueprint,
    bloglist_blueprint,
)
from .request_membership import (
    MembershipService,
    MembershipResource,
    MemberListService,
    MemberListResource,
...
superdesk.privilege(
    name="blogs", label="Blog Management", description="User can manage blogs"
)
superdesk.privilege(
    name="request_membership",
    label="Can create a request",
    description="User can create a request",
)
