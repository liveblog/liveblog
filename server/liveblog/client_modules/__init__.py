...
from liveblog.client_modules.client_modules import (
    ...
    ClientUsersResource,
    ClientUsersService,
    ClientBlogPostsService,
    ClientBlogPostsResource,
    ClientCommentsService,
    ClientCommentsResource,
    ClientItemsService,
    ClientItemsResource,
    ClientAdvertisementsResource,
    ClientAdvertisementsService,
    ClientCollectionsResource,
    ClientCollectionsService,
    ClientOutputsResource,
...
def init_app(app):
    ...
    service = ClientAdvertisementsService(
