...
from .syndication import (
    SyndicationOut,
    SyndicationOutService,
    SyndicationIn,
    SyndicationInService,
)
...
def init_app(app):
    ...
    service = BlogPostsService(
        "syndication_blog_posts", backend=superdesk.get_backend()
    )
...
superdesk.privilege(
    ...
    description="User can manage consumers",
)
superdesk.privilege(
    name="producers",
    label="Producers Management",
    description="User can manage producers",
)
superdesk.privilege(
    name="syndication_out",
    label="Consumer Syndication Management",
...
superdesk.privilege(
    name="syndication_in_p",
    label="Producer Syndication Management",
