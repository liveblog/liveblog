...
def extract_post_items_data(original_doc):
    ...
    # SYNDCREATOR user_service = get_resource_service('users')
    ...
    for group in original_doc['groups']:
        if group['id'] == 'main':
            for ref in group['refs']:
                ...
                # SYNDCREATOR sydicated_creator = user_service.find_one(req=None, _id=item('original_creator'))
                text = item.get('text')
                ...
                data = {
                    ...
                    # SYNDCREATOR 'commenter': item.get('commenter'),
                    # SYNDCREATOR 'sydicated_creator': sydicated_creator,
                    'meta': meta
                }
                items.append(data)
    return items
